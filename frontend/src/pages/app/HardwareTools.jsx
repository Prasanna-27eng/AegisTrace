...
const CATEGORIES = [
  {
    id: 'wifi', label: 'WiFi Attack', icon: Wifi, color: '#C0392B',
    tools: [
  ...
  {
    id: 'endpoint', label: 'Endpoint', icon: Monitor, color: '#C0392B',
    tools: [
          ...
          <>
            ...
            {result.suspicious_clients?.length > 0 && (
              <div style={{margin:'14px 16px 0'}}>
                <div style={{fontSize:'0.68rem',color:'#C0392B',fontWeight:700,marginBottom:6,fontFamily:'JetBrains Mono',textTransform:'uppercase',letterSpacing:'0.06em'}}>Suspicious Clients</div>
        ...
        return (
          <>
            ...
            {result.evil_twin_suspects?.length > 0 && (
              <div style={{margin:'14px 16px 0'}}>
                <div style={{fontSize:'0.68rem',color:'#C0392B',fontWeight:700,marginBottom:6,fontFamily:'JetBrains Mono',textTransform:'uppercase',letterSpacing:'0.06em'}}>Evil Twin Suspects</div>
            ...
            <div key={cat.id}>
              ...
              {cat.tools.map(t => (
                ...
                >
                  ...
                  {selected === t.key && <ChevronRight size={12} style={{ color: '#C0392B', flexShrink:0 }} />}
                </div>
              ))}
            </div>
          ))}
