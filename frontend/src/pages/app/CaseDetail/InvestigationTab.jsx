    ...
    <div style={{ padding: '20px 24px' }}>
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <div className="at-card" style={{ padding: 16 }}>
            ...
            {evidence.length === 0 ? (
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                {evidence.map(ev => (
                  <div key={ev.id} style={{ background: '#0F1018', borderRadius: 6, padding: '10px 12px', border: `1px solid ${ev.analyst_confirmed ? 'rgba(34,197,94,0.2)' : 'rgba(255,255,255,0.05)'}` }}>
          ...
          {/* Add evidence modal */}
          {showAddEv && (
            <div className="at-card" style={{ padding: 16, borderColor: 'rgba(192,57,43,0.25)' }}>
