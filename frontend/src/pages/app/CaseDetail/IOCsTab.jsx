...
export default function IOCsTab({ caseData, updateCase, caseId }) {
  ...
  return (
    <div style={{ padding: '20px 24px' }}>
      ...
      {/* Add form */}
      {showAdd && (
        <div className="at-card" style={{ padding: 14, marginBottom: 16, borderColor: 'rgba(192,57,43,0.25)' }}>
          ...
          {iocs.map((item, i) => (
            <div key={i}>
              ...
              {correlations[item.ioc]?.found && correlations[item.ioc].case_count > 1 && (
                <div style={{ marginTop: 3, marginLeft: 8, padding: '6px 10px', background: 'rgba(192,57,43,0.06)', border: '1px solid rgba(192,57,43,0.15)', borderRadius: 5, fontSize: '0.72rem', color: '#C0392B' }}>
