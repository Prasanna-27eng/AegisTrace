        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
              {[
                ...
                <div key={key} style={full ? { gridColumn: '1/-1' } : {}}>
                  <label style={{ fontSize: '0.7rem', color: 'rgba(26,22,18,0.5)', display: 'block', marginBottom: 4 }}>{label}</label>
                  <input className="at-input" value={caseData[key] || ''} onChange={e => updateCase({ [key]: e.target.value })} style={{ fontSize: '0.8rem' }} />
                </div>
              ))}
              <div>
                <label style={{ fontSize: '0.7rem', color: 'rgba(26,22,18,0.5)', display: 'block', marginBottom: 4 }}>Severity</label>
              ...
              <div>
                <label style={{ fontSize: '0.7rem', color: 'rgba(26,22,18,0.5)', display: 'block', marginBottom: 4 }}>Status</label>
              ...
              <div style={{ gridColumn: '1/-1' }}>
                <label style={{ fontSize: '0.7rem', color: 'rgba(26,22,18,0.5)', display: 'block', marginBottom: 4 }}>Incident Type</label>
          ...
          <div className="at-card" style={{ padding: 16 }}>
            ...
            <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
              <input className="at-input" readOnly value={`${window.location.origin}/public/${caseData.share_token}`} style={{ fontSize: '0.72rem', fontFamily: 'JetBrains Mono', color: 'rgba(26,22,18,0.5)' }} />
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          {caseData.ai_executive_summary && (
            <div className="at-card" style={{ padding: 16, borderLeft: '2px solid rgba(143,175,192,0.4)' }}>
              ...
              <p style={{ fontSize: '0.82rem', color: 'rgba(26,22,18,0.5)', lineHeight: 1.7 }}>{caseData.ai_executive_summary}</p>
              {caseData.ai_severity_score && (
                <div style={{ marginTop: 10, display: 'flex', alignItems: 'center', gap: 8 }}>
                  <span style={{ fontSize: '0.72rem', color: 'rgba(26,22,18,0.5)' }}>AI Severity Score:</span>
          ...
          {iocs.length > 0 && (
            <div className="at-card" style={{ padding: 16 }}>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6 }}>
                ...
                {iocs.length > 12 && <span style={{ fontSize: '0.72rem', color: 'rgba(26,22,18,0.5)', padding: '2px 6px' }}>+{iocs.length - 12} more</span>}
              </div>
            </div>
          )}
              ...
              {!showClose ? (
                ...
                <div className="at-card" style={{ padding: 16, borderColor: 'rgba(239,68,68,0.2)' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12 }}>
                    ...
                    <label htmlFor="ev-check" style={{ fontSize: '0.78rem', color: 'rgba(26,22,18,0.6)' }}>Evidence checklist complete</label>
                  </div>
