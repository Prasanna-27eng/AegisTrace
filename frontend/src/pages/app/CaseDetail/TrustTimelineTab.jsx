...
import { GitBranch, Plus, Loader2, X, Shield, User, Bot, Zap, Check, AlertTriangle, Lock, Key, Activity } from 'lucide-react';
...
const CATEGORY_META = {
  ...
  response_action: { label: 'Response Action',   color: '#C0392B',  Icon: Zap },
