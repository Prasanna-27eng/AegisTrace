    ...
    <div style={{ padding: '16px 0', display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', alignItems: 'center' }}>
        {edrStatus ? (
          <>
            {Object.entries(edrStatus.platforms).map(([name, info]) => (
              <div key={name} style={{
                ...
                <span style={{ fontSize: '0.62rem', color: '#71717A', fontFamily: 'JetBrains Mono' }}>
          ...
          <div style={{ fontSize: '0.72rem', color: '#71717A', display: 'flex', alignItems: 'center', gap: 6 }}>
      ...
      <div className="at-card" style={{ padding: '14px 16px' }}>
        ...
        <div style={{ display: 'flex', gap: 8 }}>
          <input
            ...
            style={{
              flex: 1, padding: '7px 10px', background: '#0F1018',
        ...
        {endpoints.length === 0 && !searching && searchQuery && (
          <div style={{ marginTop: 10, fontSize: '0.78rem', color: '#71717A', textAlign: 'center', padding: '12px 0' }}>
        ...
        <div className="at-card" style={{ padding: '14px 16px' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 14 }}>
            <div>
              ...
              <div style={{ fontSize: '0.67rem', color: '#71717A', fontFamily: 'JetBrains Mono' }}>
            ...
            <div style={{ marginBottom: 14 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
                ...
                <input
                  ...
                  style={{
                    padding: '3px 8px', background: '#0F1018',
              ...
              <div style={{ maxHeight: 220, overflowY: 'auto', borderRadius: 6, border: '1px solid rgba(255,255,255,0.06)' }}>
                <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.72rem', fontFamily: 'JetBrains Mono' }}>
                  <thead>
                    <tr style={{ background: '#0F1018', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
                  ...
                  <tbody>
                    {filteredProcs.slice(0, 80).map((p, i) => (
                      <tr key={i} style={{ borderBottom: '1px solid rgba(255,255,255,0.04)', background: i % 2 ? 'transparent' : 'rgba(255,255,255,0.01)' }}>
                        ...
                        <td style={{ padding: '4px 8px', color: '#71717A' }}>{p.user || '—'}</td>
              ...
              <div style={{ display: 'flex', gap: 6, marginTop: 8, alignItems: 'center' }}>
                <span style={{ fontSize: '0.72rem', color: '#71717A' }}>Kill PID:</span>
                <input
                  value={pidInput}
                  onChange={e => setPidInput(e.target.value)}
                  placeholder="Enter PID…"
                  style={{
                    width: 80, padding: '4px 8px', background: '#0F1018',
                ...
                <button
                  ...
                  style={{
                    ...
                    borderRadius: 4, color: pidInput.trim() ? '#EF4444' : '#71717A',
          ...
          <div>
            ...
            <div style={{ fontSize: '0.68rem', color: '#71717A', marginBottom: 6 }}>
            ...
            <div style={{ display: 'flex', gap: 6 }}>
              <input
                ...
                style={{
                  flex: 1, padding: '6px 10px', background: '#0F1018',
                  border: '1px solid rgba(255,255,255,0.08)', borderRadius: 6,
            ...
            {cmdOutput && (
              <pre style={{
                marginTop: 8, padding: '10px 12px', background: '#070810',
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
            {actionLog.map((l, i) => (
              <div key={i} style={{ display: 'flex', gap: 8, alignItems: 'baseline', fontSize: '0.72rem' }}>
                <span style={{ color: '#71717A', fontFamily: 'JetBrains Mono', flexShrink: 0, fontSize: '0.62rem' }}>
      ...
      {history.length > 0 && (
        <div className="at-card" style={{ padding: '12px 16px' }}>
          ...
          >
            ...
            {showHistory ? <ChevronDown size={13} style={{ color: '#71717A' }} /> : <ChevronRight size={13} style={{ color: '#71717A' }} />}
          </div>
          {showHistory && (
            <div style={{ marginTop: 10, display: 'flex', flexDirection: 'column', gap: 4 }}>
              {history.map(a => (
                <div key={a.id} style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: '0.72rem', padding: '4px 0', borderBottom: '1px solid rgba(255,255,255,0.04)' }}>
                  ...
                  <span style={{ color: '#F0F0F8', fontWeight: 500 }}>{a.hostname || a.endpoint_id}</span>
                  {a.target && <span style={{ color: '#71717A', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', maxWidth: 160 }}>{a.target}</span>}
                  <span style={{ marginLeft: 'auto', color: '#71717A', fontFamily: 'JetBrains Mono', fontSize: '0.62rem', flexShrink: 0 }}>
