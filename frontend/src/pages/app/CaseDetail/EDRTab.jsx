      ...
      <div className="at-card" style={{ padding: '14px 16px' }}>
        ...
        <div style={{ display: 'flex', gap: 8 }}>
          <input
            ...
            style={{
              flex: 1, padding: '7px 10px', background: '#1F2937',
          ...
          <div style={{ marginTop: 10, display: 'flex', flexDirection: 'column', gap: 5 }}>
            {endpoints.map(ep => (
              <div
                ...
                onMouseLeave={e => { if (selected?.endpoint_id !== ep.endpoint_id) e.currentTarget.style.background = '#1F2937'; }}
              >
            ...
            <div style={{ marginBottom: 14 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
                ...
                <input
                  ...
                  style={{
                    padding: '3px 8px', background: '#1F2937',
              ...
              <div style={{ maxHeight: 220, overflowY: 'auto', borderRadius: 6, border: '1px solid rgba(255,255,255,0.06)' }}>
                <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.72rem', fontFamily: 'JetBrains Mono' }}>
                  <thead>
                    <tr style={{ background: '#1F2937', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
              ...
              <div style={{ display: 'flex', gap: 6, marginTop: 8, alignItems: 'center' }}>
                ...
                <input
                  ...
                  style={{
                    width: 80, padding: '4px 8px', background: '#1F2937',
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: 6 }}>
              <input
                ...
                style={{
                  flex: 1, padding: '6px 10px', background: '#1F2937',
                  border: '1px solid rgba(255,255,255,0.08)', borderRadius: 6,
