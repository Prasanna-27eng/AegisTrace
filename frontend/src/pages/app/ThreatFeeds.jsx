...
const SOURCE_META = {
  cisa_kev:      { label: 'CISA KEV',        color: '#C0392B', icon: AlertTriangle, url: 'https://www.cisa.gov/known-exploited-vulnerabilities-catalog' },
        ...
        <>
          ...
          {feedKey === 'cisa_kev' && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: 5 }}>
              {items.map((v, i) => (
                <div key={i} style={{ display: 'flex', gap: 10, padding: '7px 10px', background: '#0F1018', borderRadius: 5, fontSize: '0.74rem', alignItems: 'flex-start' }}>
          ...
          {feedKey === 'urlhaus' && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
              {items.map((u, i) => (
                <div key={i} style={{ display: 'flex', gap: 8, padding: '6px 10px', background: '#0F1018', borderRadius: 5, fontSize: '0.72rem', alignItems: 'center' }}>
                  <span style={{
