...
function ScoreBar({ score }) {
  const color = score > 70 ? '#C0392B' : score > 40 ? '#EAB308' : '#22C55E';
  return (
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 280px', gap: 16, alignItems: 'start' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          <div
            ...
            style={{
              border: `2px dashed ${dragging ? 'rgba(192,57,43,0.5)' : 'rgba(255,255,255,0.1)'}`,
              borderRadius: 10, padding: '28px 20px', textAlign: 'center', cursor: 'pointer',
              background: dragging ? 'rgba(192,57,43,0.04)' : 'rgba(255,255,255,0.02)',
              transition: 'all 0.2s',
            }}
          >
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8 }}>
                ...
                <div style={{ display: 'flex', gap: 8, marginTop: 4 }}>
                  <input
                    ...
                    style={{
                      padding: '5px 10px', background: '#0F1018',
                ...
                <Section title="AI Key Findings" icon={Shield} defaultOpen={true}>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 5 }}>
                    ...
                    {result.ai_likely_attack && result.ai_likely_attack !== 'None' && (
                      <div style={{ marginTop: 4, fontSize: '0.75rem', padding: '5px 10px', background: 'rgba(192,57,43,0.06)', borderRadius: 4, color: '#EF4444' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                    {result.suspicious_flows.map((f, i) => (
                      <div key={i} style={{
                        ...
                        background: f.severity === 'high' ? 'rgba(192,57,43,0.07)' : 'rgba(234,179,8,0.06)',
                        border: `1px solid ${f.severity === 'high' ? 'rgba(192,57,43,0.2)' : 'rgba(234,179,8,0.2)'}`,
                      }}>
