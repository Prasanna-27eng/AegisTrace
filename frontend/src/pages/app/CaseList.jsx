    ...
    <div style={{ padding: '20px 24px' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 16, flexWrap: 'wrap', gap: 10 }}>
        <div>
          ...
          <div style={{ display: 'flex', gap: 12, marginTop: 4, fontSize: '0.7rem', fontFamily: 'JetBrains Mono' }}>
            ...
            {critical > 0 && <span style={{ color: '#6366F1' }}>{critical} critical</span>}
        ...
        {QUICK_FILTERS.map((f, idx) => (
          <button
            ...
            style={{
              ...
              background: activeChip === idx ? '#6366F1' : 'rgba(255,255,255,0.04)',
              color: activeChip === idx ? '#fff' : '#71717A',
              border: activeChip === idx ? '1px solid #6366F1' : '1px solid rgba(255,255,255,0.08)',
            }}
          >
            {f.label}
          </button>
      ...
      {loading ? (
        ...
        <div style={{ textAlign: 'center', padding: '60px 20px' }}>
          <FolderOpen size={36} style={{ color: 'rgba(99,102,241,0.2)', margin: '0 auto 14px', display: 'block' }} />
          ...
          {cases.map(c => {
            ...
            return (
              ...
              >
                {/* Severity left bar */}
                {c.severity === 'critical' && (
                  <div className="critical-pulse" style={{ position: 'absolute', left: 0, top: 0, bottom: 0, width: 3, borderRadius: '8px 0 0 8px', background: '#6366F1' }} />
                )}
