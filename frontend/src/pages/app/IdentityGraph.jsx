...
const NODE_TYPES = [
  { id: 'user',            label: 'Human User',      color: '#C0392B',  Icon: User },
...
function NodePanel({ node, onMarkCompromised, onDelete, onClose }) {
  ...
  return (
    <div style={{ width: 280, background: '#0B0D14', borderLeft: '1px solid rgba(255,255,255,0.07)', display: 'flex', flexDirection: 'column', overflow: 'auto' }}>
    ...
    <div style={{ display: 'flex', height: '100%', background: '#07080F', overflow: 'hidden' }}>
      ...
      <div style={{ width: 220, flexShrink: 0, background: '#0B0D14', borderRight: '1px solid rgba(255,255,255,0.07)', display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ padding: '8px 10px', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 6, background: '#07080F', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 5, padding: '4px 8px' }}>
      ...
      {showAdd && (
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.7)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 100 }} onClick={() => setShowAdd(false)}>
          <div style={{ background: '#0F1018', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 10, padding: 24, width: 380, maxWidth: '90vw' }} onClick={e => e.stopPropagation()}>
      ...
      {showEdge && (
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.7)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 100 }} onClick={() => setShowEdge(false)}>
          <div style={{ background: '#0F1018', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 10, padding: 24, width: 360, maxWidth: '90vw' }} onClick={e => e.stopPropagation()}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 18 }}>
