...
export default function ToolResult() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#080C14', color: '#F0F0F8' }}>
      {/* Header */}
      <header style={{ background: '#0D1117', borderBottom: '1px solid rgba(255,255,255,0.07)', padding: '14px 32px', display: 'flex', alignItems: 'center', gap: 20, position: 'sticky', top: 0, zIndex: 10 }}>
        ...
        {run && !loading && (
          <>
            <div style={{ marginBottom: 24 }}>
              ...
              {run.case_id && <span style={{ fontFamily: 'JetBrains Mono', fontSize: '0.72rem', background: 'rgba(99,102,241,0.1)', border: '1px solid rgba(99,102,241,0.25)', color: '#6366F1', padding: '2px 8px', borderRadius: 3 }}>Linked to Case #{run.case_id}</span>}
            </div>
