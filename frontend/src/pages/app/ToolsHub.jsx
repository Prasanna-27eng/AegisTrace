...
const TOOLS = [
  { id: 'whois', name: 'WHOIS / RDAP Lookup', desc: 'Domain registration and ownership lookup', inputs: ['domain'], link: 'https://lookup.icann.org', linkLabel: 'ICANN RDAP', color: '#C0392B' },
  ...
  { id: 'urlscan', name: 'URL Scanner', desc: 'Submit URL for sandboxed scanning', inputs: ['url'], link: 'https://urlscan.io/', linkLabel: 'urlscan.io', color: '#C0392B' },
  ...
  { id: 'mxtoolbox', name: 'MX Toolbox', desc: 'Email delivery and blacklist checks', inputs: ['domain','ip'], link: 'https://mxtoolbox.com/', linkLabel: 'MX Toolbox', color: '#C0392B' },
          ...
          >
            ...
            {tool.id === 'defang-tool' && activeInternal === tool.id && (
              <div style={{ marginTop: 12, borderTop: '1px solid rgba(255,255,255,0.07)', paddingTop: 12 }} onClick={e => e.stopPropagation()}>
                ...
                {defangResult && (
                  <div style={{ display: 'flex', gap: 6, alignItems: 'center', background: '#0F1018', padding: '6px 10px', borderRadius: 5 }}>
