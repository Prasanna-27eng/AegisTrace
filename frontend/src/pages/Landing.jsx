...
const PROBLEMS = [
  { Icon:UserX,       title:'Identity is the new perimeter',            desc:'Attackers no longer break through firewalls — they log in with stolen credentials, hijacked tokens, or abused service accounts. Traditional SOC tools track machines. AegisTrace tracks identities.', color:'#C0392B' },
...
export default function Landing() {
  ...
  return (
    <div style={{background:'#07080F',color:'#F0F0F8',minHeight:'100vh',cursor:'crosshair',overflowX:'hidden'}}>
      ...
      {/* ══ THE PROBLEM ══ */}
      <section id="problem" className="lp-section" style={{padding:'90px 48px',background:'#07080F',borderTop:'1px solid rgba(240,240,248,0.05)'}}>
        <div style={{maxWidth:1200,margin:'0 auto'}}>
          <div style={{marginBottom:52}}>
            <div style={{fontSize:10,color:'#C0392B',letterSpacing:'0.2em',textTransform:'uppercase',...mono,marginBottom:12}}>◇ The Problem</div>
            <h2 style={{fontFamily:'Instrument Serif,serif',fontSize:'clamp(2rem,4vw,3.4rem)',fontWeight:400,letterSpacing:'-0.02em',lineHeight:1.1,maxWidth:700}}>
              ...
              <span style={{color:'#C0392B',fontStyle:'italic'}}>than most platforms can follow.</span>
            </h2>
          ...
          {/* Stats callout */}
          <div style={{marginTop:48,padding:'28px 36px',background:'rgba(192,57,43,0.05)',border:'1px solid rgba(192,57,43,0.15)',borderRadius:10,display:'grid',gridTemplateColumns:'1fr auto 1fr auto 1fr',gap:24,alignItems:'center',flexWrap:'wrap'}}>
            <div>
              <div style={{fontFamily:'Instrument Serif,serif',fontSize:'clamp(1.8rem,3vw,2.8rem)',color:'#C0392B',fontWeight:400,fontStyle:'italic'}}>83%</div>
            ...
            <div style={{width:1,height:60,background:'rgba(192,57,43,0.2)'}}/>
            <div>
      ...
      {/* ══ FUTURE VISION ══ */}
      <section id="vision" className="lp-section" style={{padding:'90px 48px',background:'#0F1018',borderTop:'1px solid rgba(240,240,248,0.05)'}}>
        <div style={{maxWidth:1200,margin:'0 auto'}}>
          <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:64,alignItems:'start',marginBottom:56}} className="lp-2col">
            ...
            <div style={{display:'flex',flexDirection:'column',gap:0}}>
              {[
                {from:'Case manager',          to:'Trust orchestration platform',    color:'#C0392B'},
                ...
                {from:'Manual triage',         to:'Autonomous + human-approved',     color:'#C0392B'},
      ...
      <section style={{padding:'80px 48px',background:'#07080F',borderTop:'1px solid rgba(240,240,248,0.05)'}}>
        <div style={{maxWidth:1200,margin:'0 auto'}}>
          <div style={{marginBottom:48}}>
            <div style={{fontSize:10,color:'#C0392B',letterSpacing:'0.2em',textTransform:'uppercase',...mono,marginBottom:12}}>◇ What This Platform Solves</div>
            <h2 style={{fontFamily:'Instrument Serif,serif',fontSize:'clamp(2rem,4vw,3.2rem)',fontWeight:400,letterSpacing:'-0.02em'}}>
              Built to answer the questions<br/><span style={{color:'#C0392B',fontStyle:'italic'}}>that matter most.</span>
            </h2>
          </div>
          <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(340px,1fr))',gap:20}}>
            {[
              { q:'Who or what caused this incident?', a:'AegisTrace tracks every actor — human user, service account, API key, AI agent, or device — as an identity node in a graph. Every action is linked to an identity, and every identity carries a risk score and a trust history.', Icon:Fingerprint, color:'#C0392B' },
              ...
              { q:'Are we ready for what comes next?', a:'AegisTrace is being built to remain relevant 10–15 years out — when quantum-harvested keys, prompt injection attacks, machine-to-machine abuse, and AI-native adversaries are the expected threat model, not edge cases.', Icon:TrendingUp, color:'#C0392B' },
            ].map(({q,a,Icon,color})=>(
      ...
      {/* ══ HARDWARE PLATFORM ══ */}
      <section id="hardware" className="lp-section" style={{padding:'90px 48px',background:'#0F1018',borderTop:'1px solid rgba(240,240,248,0.05)'}}>
        <div style={{maxWidth:1200,margin:'0 auto'}}>
          <div style={{display:'flex',alignItems:'flex-start',justifyContent:'space-between',gap:32,flexWrap:'wrap',marginBottom:52}}>
            <div style={{maxWidth:560}}>
              <div style={{fontSize:10,color:'#C0392B',letterSpacing:'0.2em',textTransform:'uppercase',...mono,marginBottom:10}}>◇ Session 6 — Live Now</div>
          ...
          <div style={{marginTop:28,textAlign:'center'}}>
            <button onClick={openApp} style={{background:'#C0392B',color:'#fff',border:'none',borderRadius:6,padding:'12px 32px',fontSize:12,fontWeight:600,cursor:'pointer',...mono,letterSpacing:'0.08em',textTransform:'uppercase'}}>Open Hardware Tools →</button>
          </div>
        </div>
      </section>
        ...
        <div style={{maxWidth:1100,margin:'0 auto'}}>
          <div style={{marginBottom:40,display:'flex',alignItems:'flex-end',justifyContent:'space-between',flexWrap:'wrap',gap:16}}>
            <div>
              ...
              <h2 style={{fontFamily:'Instrument Serif,serif',fontSize:'clamp(2rem,4vw,3.2rem)',fontWeight:400,letterSpacing:'-0.02em',lineHeight:1.1}}>Try the AI<br/><span style={{color:'#C0392B',fontStyle:'italic'}}>right now.</span></h2>
            </div>
      ...
      {/* ══ ROADMAP ══ */}
      <section id="roadmap" className="lp-section" style={{padding:'90px 48px',background:'#07080F',borderTop:'1px solid rgba(240,240,248,0.05)'}}>
        <div style={{maxWidth:1200,margin:'0 auto'}}>
          <div style={{marginBottom:52}}>
      ...
      <section style={{padding:'80px 48px',background:'#07080F',borderTop:'1px solid rgba(240,240,248,0.05)'}}>
        <div style={{maxWidth:1200,margin:'0 auto'}}>
          <div style={{marginBottom:40}}>
            <div style={{fontSize:10,color:'#C0392B',letterSpacing:'0.2em',textTransform:'uppercase',...mono,marginBottom:10}}>◇ AI Engine — 100% Free via Groq</div>
      ...
      {/* ══ TECH STACK ══ */}
      <section style={{padding:'72px 48px',background:'#07080F',borderTop:'1px solid rgba(240,240,248,0.05)'}}>
        <div style={{maxWidth:1200,margin:'0 auto'}}>
          <div style={{marginBottom:40}}>
            <div style={{fontSize:10,color:'#C0392B',letterSpacing:'0.2em',textTransform:'uppercase',...mono,marginBottom:10}}>◇ Technology Stack — All Free Tier</div>
            <h2 style={{fontFamily:'Instrument Serif,serif',fontSize:'clamp(2rem,4vw,3rem)',fontWeight:400,letterSpacing:'-0.02em'}}>Enterprise-grade.<br/><span style={{color:'#C0392B',fontStyle:'italic'}}>Zero cost.</span></h2>
          </div>
          <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(180px,1fr))',gap:12}}>
            {[
              ...
              <div key={name} style={{background:'rgba(240,240,248,0.02)',border:'1px solid rgba(240,240,248,0.07)',borderRadius:8,padding:'14px 16px'}}>
                ...
                <div style={{fontSize:11,color:'#C0392B',...mono,marginBottom:4}}>{role}</div>
      ...
      {/* ══ ABOUT / CERTS ══ */}
      <section id="certs" style={{padding:'80px 48px',background:'#0F1018',borderTop:'1px solid rgba(240,240,248,0.05)'}}>
      ...
      {/* ══ CTA + FOOTER ══ */}
      <section style={{padding:'80px 48px 48px',borderTop:'1px solid rgba(240,240,248,0.05)',background:'#0B0D14'}}>
        <div style={{maxWidth:1200,margin:'0 auto'}}>
