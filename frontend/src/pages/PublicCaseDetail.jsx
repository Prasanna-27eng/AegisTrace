      ...
      <div style={{ maxWidth: 840, margin: '0 auto', padding: '44px 32px 80px' }}>
        ...
        <div style={{ marginBottom: 36 }}>
          ...
          <div style={{ display: 'flex', gap: 7, marginBottom: 16, flexWrap: 'wrap', alignItems: 'center' }}>
            ...
            <span style={{ fontSize: '0.62rem', color: 'rgba(77,163,255,0.5)', fontFamily: 'JetBrains Mono', display: 'flex', alignItems: 'center', gap: 4 }}>
          ...
          <div style={{ fontSize: '0.62rem', color: 'rgba(77,163,255,0.35)', fontFamily: 'JetBrains Mono', display: 'flex', alignItems: 'center', gap: 6 }}>
        ...
        {c.ai_executive_summary && (
          <div style={{ marginBottom: 44, padding: '20px 24px', background: 'rgba(77,163,255,0.04)', border: '1px solid rgba(77,163,255,0.18)', borderRadius: 12, borderLeft: '3px solid rgba(77,163,255,0.6)' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12 }}>
              <Brain size={14} style={{ color: '#4DA3FF' }} />
              <span style={{ fontSize: '0.72rem', fontWeight: 600, color: '#4DA3FF', textTransform: 'uppercase', letterSpacing: '0.1em', fontFamily: 'JetBrains Mono' }}>AI Executive Summary</span>
              <span style={{ fontSize: '0.62rem', color: 'rgba(77,163,255,0.5)', fontFamily: 'JetBrains Mono', marginLeft: 4 }}>Generated by AegisTrace AI</span>
            </div>
        ...
        <div style={{ marginBottom: 48 }}>
          <div style={{ fontSize: '0.65rem', color: '#4DA3FF', fontFamily: 'JetBrains Mono', letterSpacing: '0.2em', textTransform: 'uppercase', marginBottom: 28, display: 'flex', alignItems: 'center', gap: 8 }}>
            <div style={{ width: 20, height: 1, background: '#4DA3FF' }} />Investigation Narrative
          </div>
          ...
          {timeline.length > 0 && (
            <StoryStep n={2} label="Investigation — Key Steps" icon={Search} color="#4DA3FF">
                ...
                {timeline.map((ev, i) => (
                  <div key={i} style={{ display: 'flex', gap: 14, padding: '10px 14px', background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: 8 }}>
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', flexShrink: 0, paddingTop: 2 }}>
                      <div style={{ width: 7, height: 7, borderRadius: '50%', background: ev.event_type === 'closure' ? '#22C55E' : ev.event_type === 'escalation' ? '#EF4444' : '#4DA3FF', flexShrink: 0 }} />
